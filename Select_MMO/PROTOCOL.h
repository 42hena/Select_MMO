...
#define	SERVER_TO_CLIENT_CREATE_MY_CHARACTER			0
//---------------------------------------------------------------
...
#define	SERVER_TO_CLIENT_CREATE_OTHER_CHARACTER		1
//---------------------------------------------------------------
...
#define	SERVER_TO_CLIENT_DELETE_CHARACTER			2
//---------------------------------------------------------------
...
#define	CLIENT_TO_SERVER_MOVE_START					10
//---------------------------------------------------------------
...
#define	SERVER_TO_CLIENT_MOVE_START					11
//---------------------------------------------------------------
...
#define	CLIENT_TO_SERVER_MOVE_STOP					12
//---------------------------------------------------------------
...
#define	SERVER_TO_CLIENT_MOVE_STOP					13
//---------------------------------------------------------------
...
#define	CLIENT_TO_SERVER_ATTACK1						20
//---------------------------------------------------------------
...
#define	SERVER_TO_CLIENT_ATTACK1						21
//---------------------------------------------------------------
...
#define	CLIENT_TO_SERVER_ATTACK2						22
//---------------------------------------------------------------
// 캐릭터 공격 패킷							Client -> Server
//
// 공격 키 입력시 본 패킷을 서버에게 보낸다.
...
#define	SERVER_TO_CLIENT_ATTACK2						23
//---------------------------------------------------------------
// 캐릭터 공격 패킷							Server -> Client
//
...
#define	CLIENT_TO_SERVER_ATTACK3						24
//---------------------------------------------------------------
// 캐릭터 공격 패킷							Client -> Server
//
// 공격 키 입력시 본 패킷을 서버에게 보낸다.
...
#define	SERVER_TO_CLIENT_ATTACK3						25
//---------------------------------------------------------------
// 캐릭터 공격 패킷							Server -> Client
//
...
#define	SERVER_TO_CLIENT_DAMAGE						30
//---------------------------------------------------------------
...
#define	SERVER_TO_CLIENT_SYNC						251
//---------------------------------------------------------------
...
#define	CLIENT_TO_SERVER_ECHO						252
//---------------------------------------------------------------
...
#define	SERVER_TO_CLIENT_ECHO						253
//---------------------------------------------------------------
...
#define dfSECTOR_MAX_Y 200
#define dfSECTOR_MAX_X 200
